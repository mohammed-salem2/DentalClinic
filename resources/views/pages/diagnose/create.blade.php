...
@section('body')
    <form id="form" method="POST" action="{{route('diagnose.store')}}">
        @csrf
        <div class="card-body">
            <div class="row form-group">
                <div class="col-4 mb-5">
                    ...
                    <input name="diagnose" maxlength="40" type="text" class="form-control form-control-lg @error('diagnose') is-invalid @enderror" autocomplete="off" required/>

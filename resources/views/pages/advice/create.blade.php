...
@section('body')
    <form id="form" method="POST" action="{{route('advice.store')}}">
        @csrf
        <div class="card-body">
            <div class="row form-group">
                <div class="col-12">
                    ...
                    <textarea class="details @error('advice') is-invalid @enderror" maxlength="1000" name="advice" cols="194" rows="6" autofocus></textarea>
